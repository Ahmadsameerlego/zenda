...
export function Topbar({ onMenuClick, storeName = "Fashion Hub Store" }: TopbarProps) {
  return (
    <header className="fixed top-0 right-0 left-0 lg:left-64 h-16 bg-white border-b border-gray-200 z-20 transition-all">
      <div className="flex items-center justify-between h-full px-4 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-semibold text-gray-900">{storeName}</h1>
            <p className="text-sm text-gray-500 hidden sm:block">Manage your store efficiently</p>
          </div>
        </div>
            ...
            <DropdownMenuContent align="end" className="w-56">
              <DropdownMenuLabel>
                <div>
                  ...
                  <p className="text-xs text-gray-500">sarah@fashionhub.com</p>
                </div>
              </DropdownMenuLabel>
              <DropdownMenuSeparator />
