    ...
    return (
        <div className="flex flex-col md:flex-row md:items-baseline justify-between gap-6 mb-12">
            ...
            <div className="flex items-center gap-3">
                <span className="text-[10px] font-black text-muted-foreground uppercase tracking-[0.2em] hidden md:block">
                    {isArabic ? 'ترتيب:' : 'SORT:'}
                </span>
                <Select onValueChange={onSortChange} defaultValue="newest">
                    <SelectTrigger className="w-[160px] h-10 rounded-xl border-border font-bold bg-card shadow-sm hover:border-gray-900 transition-all text-xs">
