...
export function ProductCard({
    ...
    return (
        <div
            ...
            className="group relative flex flex-col cursor-pointer transition-all duration-500 rounded-3xl overflow-hidden bg-white"
        >
            {/* Image Wrapper */}
            <div className="relative aspect-[3/4] overflow-hidden bg-gray-50">
                ...
                <div className="absolute inset-x-6 bottom-6 translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                    <button
                        className="w-full h-14 bg-white text-gray-900 rounded-full flex items-center justify-center gap-3 text-xs font-black uppercase tracking-[0.2em] shadow-2xl border border-white/20 hover:bg-gray-900 hover:text-white transition-all duration-300"
                        onClick={(e) => {
                            e.stopPropagation();
            ...
            <div className={cn(
                ...
                <div className="space-y-1">
                    <span className="text-[9px] font-black text-gray-300 uppercase tracking-[0.35em]">
                        ...
                        <span className="text-lg font-black tracking-tight text-gray-900">
                            {(product.sale_price !== null && product.sale_price !== undefined) ? (
                                <>
                                    ...
                                    <span className="text-[10px] font-black mr-1 text-gray-300 uppercase tracking-widest leading-none">
                                        {isArabic ? 'ج.م' : 'EGP'}
                                    </span>
                                </>
                            ) : (
