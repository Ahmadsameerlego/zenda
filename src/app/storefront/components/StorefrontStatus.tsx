        ...
        <div className="min-h-screen bg-gray-50 overflow-hidden" dir="rtl">
            ...
            <div className="h-[40vh] bg-gray-200 relative">
                <div className="absolute -bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center space-y-4">
                    <div className="size-32 rounded-3xl bg-white p-2 shadow-xl">
            ...
            <div className="max-w-7xl mx-auto px-6 mt-32 space-y-20">
                ...
                <div className="space-y-10">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                        {[1, 2, 3, 4].map(i => (
                            <div key={i} className="aspect-[4/5] bg-white rounded-3xl border border-gray-100 p-4 space-y-4 shadow-sm">
                                <div className="aspect-[4/4] bg-gray-100 rounded-2xl" />
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-white p-6" dir="rtl">
            ...
            >
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl font-black text-gray-900">المتجر غير موجود</h1>
